...
TEST(BinarySearchTree, streamInsertionOperator0) {
    BinarySearchTree<int, int> tree;
    std::ostringstream stream;
    stream << tree;
    auto s = stream.str();
...
TEST(BinarySearchTree, streamInsertionOperator1) {
    BinarySearchTree<int, int> tree;
    tree.insert(1, 1);
    std::ostringstream stream;
    stream << tree;
...
TEST(BinarySearchTree, streamInsertionOperator3) {
    BinarySearchTree<int, int> tree;
    tree.insert(2, 2);
    tree.insert(1, 1);
    tree.insert(3, 3);
...
TEST(BinarySearchTree, streamInsertionOperator7) {
    BinarySearchTree<int, int> tree;
    tree.insert(4, 4);
    tree.insert(2, 2);
    tree.insert(1, 1);
